...
*/
ob_start();
define('API_KEY','915220200:AAG5sf_2H7jbt5-GMnB5shKmEdWsT14w2jQ');
$mybot="Uzb_Posbon_Bot";
$admin = "1232898350"; 
...
if($text1 == "/sozlama" or $text == "/sozlama@VunderBot"){
$gett = bot('getChatMember', [
'chat_id' => $chat_id,
'user_id' => $fadmin,
]);
...
Guruxni sozlash uchun @VunderBot ga kiring.</b>",
'parse_mode'=>'html',
]);
...
if($text1 == "/start" or $text1 == "/start@VunderBot"){
...
$bugun = date('d-M Y',strtotime('0 hour'));
   ...
   'chat_id'=>$chat_id2,
    ...
    'text'=> "┌ @VUNDERBOT NING YANGI STATISTIKASI. 
├▶
├▶ <b>A'ZOLAR: $us</b>
├▶ <b>GURUHLAR: $gr</b>
├▶ <b>BARCHASI: $obsh</b>
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
  [['text'=>'🔄YANGILASH','callback_data' => "stat2"],['text'=>'➕GURUH QOSHISH','url'=>'telegram.me/VunderBot?startgroup=new']],
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
  [['text'=>'🔄YANGILASH','callback_data' => "stat1"],['text'=>'➕GURUH QOSHISH','url'=>'telegram.me/VunderBot?startgroup=new']],
[['text'=>'🔙Orqaga qaytish','callback_data' => "orqa"]],
]
]),
]);
}
if($text1 == "🔔 ANKETANI TOʻLDIRISH 🔔" or $text1 == "/start@VunderBot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
  [['text'=>"➕Guruhga qo‘shish",'url'=>'t.me/VunderBot?startgroup=new'],['text'=>'🔙Orqaga qaytish', 'callback_data'=>"orqa1"]],
]
]),
]);
}
...
[['text'=>'➕BOTNI GURUHGA QOSHISH','url'=>'telegram.me/VunderBot?startgroup=new']],
]
]),
]);
}
...
▶️BOT DASTURCHISI: @iNet_Hack
▶️BOT YASASH XIZMATI: @iNet_Hack</b>",
'parse_mode' => 'html',
'disable_web_page_preview'=>true,
'reply_markup'=>json_encode(
['inline_keyboard' => [
...
[✅ BOT XAQIDA MA'LUMOT](https://telegra.ph/VunderBot-Malumot-01-03)
...
if($text1 == "🤖BOT YASAB BERISH XIZMATI🤖" or $text1 == "/start@VunderBot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
'reply_markup'=>json_encode(
['inline_keyboard' => [
[["text"=>"👨‍💻BOT YASASH XIZMATI👨‍💻","url"=>"https://t.me/iNet_Hack"],],
]   
]),
]);
}
}
if($text1 == "📚SIZNING SHAXSIY KABINETINGIZ📚" or $text1 == "/start@VunderBot"){
if($cty == "supergroup" or $cty == "group"){
  bot('sendChatAction',['chat_id'=>$chat_id,'action'=>"typing"]);
$st = bot('sendMessage',[
'chat_id'=>$chat_id,
...
[✅ BOT ADMINI BILAN ALOQA](https://t.me/iNet_Hack)
